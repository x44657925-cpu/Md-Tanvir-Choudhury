    ...
    <div className="space-y-5 pb-20 max-w-6xl mx-auto">
      ...
      {activeAdminTab === 'app_export' && (
        <div className="space-y-5 animate-in fade-in duration-200">
          ...
          {/* 2. Complete Offline Ready ZIP Package */}
          <div className="bg-slate-900 border border-cyan-500/30 p-5 rounded-2xl space-y-3">
            <div className="flex items-center gap-2">
              <DownloadCloud className="w-4 h-4 text-cyan-400" />
              <h4 className="text-xs sm:text-sm font-bold text-slate-100">
                {lang === 'bn' ? '২. সম্পূর্ণ অফলাইন বিল্ড ZIP প্যাকেজ' : '2. Complete Offline Build ZIP Package'}
              </h4>
            </div>
            <p className="text-xs text-slate-300 leading-relaxed">
              {lang === 'bn'
                ? 'Android Studio-র app/src/main/assets ফোল্ডারে লোকাল ফাইল হিসেবে চালানোর জন্য তৈরি করা প্রোডাকশন বান্ডেল।'
                : 'Self-contained production assets bundle ready for Android Studio app/src/main/assets/ directory.'}
            </p>
            ...
            >
              ...
              <span>
                {downloadingZip 
                  ...
                  : (lang === 'bn' ? '🔒 অ্যাডমিন ZIP ডাউনলোড করুন (188 KB)' : '🔒 Download Admin ZIP Package (188 KB)')}
              </span>
            </button>
          </div>
